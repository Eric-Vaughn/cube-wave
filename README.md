...
- Have a 2D GUI that tells the user about the controls of the program (manipulate the frequency of the wave, cube size, color pallets, etc.)
...
(REVIEW: If there isn't anything of value to add under this section, just delete it!)
